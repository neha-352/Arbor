...
select e.employeeid,e.firstname,e.lastname,d.location
from employee as e
...
left join department as d
on e.employeeid = d.departmentid
where e.departmentid = (select departmentid from employee where firstname="amit" and lastname="sharma");
...
select e.employeeid,e.firstname,e.lastname,d.departmentname,e.departmentid
from employee as e
left join department as d
on e.employeeid = d.departmentid
...
select d.departmentname,e.employeeid,e.departmentid
from employee as e
right join department as d
on e.employeeid = d.departmentid
where e.employeeid is null;

-- Retrieve all employees and their department details, ensuring all departments are listed even if they have no employees.
select *
from employee as e
join department as d
on e.employeeid = d.departmentid;