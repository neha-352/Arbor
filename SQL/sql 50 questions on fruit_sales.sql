...
INSERT INTO fruit_sales (sale_id, fruit_name, quantity, price_per_kg, sale_date, customer_name, city) VALUES
(51,'Mango',5,160.00,'2025-8-26','Omkar Mutke','Pune'),
(52,'Papaya',12,55.00,'2025-8-26','Neha Sharma','Mumbai'),
(53,'Grapes',10,90.00,'2025-8-27','Sunil Patil','Nagpur'),
(54,'Oange',20,65.00,'2025-8-28','Manisha Mutke','Aurangabad'),
(55,'Watermelon',15,30.00,'2025-8-28','Rani Patil','Pune'),
(56,'Apple',8,125.00,'2025-8-29','Seema Jagtap','Nashik'),
(57,'Banana',10,38.00,'2025-8-29','Rahul Deshmukh','Mumbai'),
(58,'Mango',25,155.00,'2025-8-30','Sai Gaikwad','Nagpur'),
(59,'Papaya',9,60.00,'2025-8-30','Prem Hire','Aurangabad'),
(60,'Orange',11,63.00,'2025-8-31','Vihan Konde','Pune');
...
select fruit_name,sum(quantity)
from fruit_sales
group by fruit_name;

-- 22.	Find the average price per kg for each fruit.
select fruit_name,avg(price_per_kg)
from fruit_sales
group by fruit_name;
...
select city,count(sale_id) as Sales_Records
from fruit_sales
group by city;

-- 25.	Find the minimum price per kg for each fruit.
select fruit_name,min(price_per_kg)
from fruit_sales
group by fruit_name;
...
select fruit_name, sum(quantity*price_per_kg)
from fruit_sales
group by fruit_name;
...
select day(sale_date),count(sale_id) as Number_Of_sales
from fruit_sales
group by day(sale_date);

-- 30.	Find the highest and lowest price of Apples sold.
select fruit_name,max(price_per_kg) as highest_Price,min(price_per_kg) as Lowest_Price
from fruit_sales
