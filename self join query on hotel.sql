...
select h.hotelid,h.hotelname,avg(r.rating) as AverageRating
from hotels as h
...
select * from hotels;
select h1.hotelid,h1.hotelname,h2.hotelid,h2.hotelname,h1.location
from hotels h1 join hotels h2
on h1.location = h2.location and h1.hotelid<h2.hotelid;


-- Question 2: Hotels with the same contact number
select * from hotels;
select h1.hotelid,h1.hotelname,h2.hotelid,h2.hotelname,h1.contactnumber
from hotels as h1
join hotels as h2
...
select * from hotels;
select h1.hotelid,h1.hotelname,h2.hotelid,h2.hotelname,h1.pricepernight
from hotels as h1
join hotels as h2
...
select * from hotels;
select h1.hotelid,h1.hotelname,h2.hotelid,h2.hotelname,h1.amenities,h1.checkintime
from hotels as h1
join hotels as h2
on h1.amenities = h2.amenities and h1.checkintime = h2.checkintime and h1.hotelid < h2.hotelid;

-- Question 5: Retrieve pairs of hotels with the same rating.
select * from hotels;
 select h1.hotelid,h1.hotelname,h2.hotelid,h2.hotelname,h1.rating
 from hotels as h1
 join hotels as h2
